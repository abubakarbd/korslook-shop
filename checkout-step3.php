        ...
        <div class="col-md-7 col-sm-7 col-xs-7">
          <div class="bread-crumb">
            <ul>
              ...
              <li>\</li>
              <li><a href="checkout-step3.php"> Paymen method</a></li>
            </ul>
          </div>
        </div>
      </div>
                      ...
                      <div class="form-group clearfix">
                        <div class="checkbox">
                          <label>
                            ...
                            I have read and agree to the <a href="terms-conditions.php">Terms &amp; Conditions</a> </label>
                        </div>
                      </div>
                      <div class="pull-right"><a class="btn btn-large btn-primary" href="checkout-step4.php"> Order&nbsp;<i class="fa fa-arrow-right"></i> </a></div>
                    </div>
                  </div>
                </div>
