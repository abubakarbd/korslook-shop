...
<!--End Pagination-->       
            ...
            <div class="product-grid-view">
              <ul>
                 <?php 
                $productbyMen = $pd->latestFromMen($start_form, $per_page);
                if($productbyMen){
                   while($result = $productbyMen->fetch_assoc()){ ?> 
                <li>
    ...
    <!--Pagination-->
          ...
          <div class="row">
            <div class="pagination-bar">
              <ul>
	<?php 
	$productbyMen = $pd->couFromMen();
	
	$total_rows = mysqli_num_rows($productbyMen);
	
	$total_pages = ceil($total_rows/$per_page);
	
    echo "<li><a href='men.php?page=1'><i class='fa fa-angle-left'></i></a></li>";
	for ($i=1; $i <= $total_pages; $i++) { 
	    echo "<li><a href='men.php?page=".$i."'>".$i."</a></li>";
	}

echo "<li><a href='men.php?page=$total_pages'><i class='fa fa-angle-right'></i></a></li>";?>
...
<!--Pagination end-->        
        ...
        <?php }else{
		    echo "<div class='product-details'>Men's Product Not Found</div>";
		}?>	      
        </div>
      </div>
    </div>
