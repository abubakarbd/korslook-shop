                    ...
                    <div class="col-lg-4">
                        <div class="page-header-breadcrumb">
                            <ul class="breadcrumb-title">
                                ...
                                <li class="breadcrumb-item"><a href="productlist.php">Product List</a>
                                </li>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-block">
                                    <?php 
                                        $getProduct = $pd->gatProductById($id);
                                        if($getProduct){
                                    ...
                                    <form  action="" method="post" enctype="multipart/form-data">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <span class="messages"><?php if(isset($updateProduct)){
                                                            echo $updateProduct;
                                                        }?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <div class="form-group row">
                                            ...
                                            <img width="100" height="80" src="<?php echo $value['image']?>">
                                        </div>
                                                        
                                        <div class="form-group row">
                                                <label class="col-sm-2 col-form-label">Product Price</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="price" id="numeric" value="<?php echo $value['price'];?>">
                                     ...
                                     <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <select class="js-example-disabled-results col-sm-12"  name="type" >
                                                    ...
                                                    <?php if($value['type'] == 0){?>
                                                    <option selected = "selected" value="0">Featurad</option>
