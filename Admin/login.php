                            ...
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="text" name="adminUser" class="form-control" required="" placeholder="Your Email Address">
                                        <span class="form-bar"></span>
                                    </div>
                                    <div class="form-group form-primary">
                                        <input type="password" name="adminPass" class="form-control" required="" placeholder="Password">
                                        <span class="form-bar"></span>
                                    </div>
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <button type="adminPass" class="btn btn-primary btn-md btn-block waves-effect waves-light text-center m-b-20">Sign in</button>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="row">
