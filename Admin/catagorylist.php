                                                       ...
                                                       <?php   
                                                            ...
                                                            <div class="dropdown-secondary dropdown d-inline-block">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdown3" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                    <a class="dropdown-item waves-light waves-effect" href="catedit.php?catid=<?php echo $result['catId'];?>"><i class="icofont icofont-edit-alt m-r-10"></i>Edit task</a>
                                                                    <a onclick="return confirm('Are your sure to Delete!')" class="dropdown-item waves-light waves-effect" href="?delcat=<?php echo $result['catId'];?>"><i class="icofont icofont-close m-r-10"></i>Remove</a>
                                                                </div>
