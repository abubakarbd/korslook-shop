...
if(isset($_GET['delcont'])){
	$id = $_GET['delcont'];
	$id = preg_replace('/[^-a-zA-Z0-9_]/', '' , $_GET['delcont']);
 	$delCont = $cont->delContById($id);
}
?>
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                       ...
                                                       <?php   
                                                            ...
                                                            <tr>
                                                                <td><?php echo $i;?></td>
                                                                <td><?php echo $result['contName']?></td>
                                                                <td><?php echo $result['mobile'];?></td>
                                                                <td><?php echo $result['agentName']?></td>
                                                                <td><?php echo $result['district'];?></td>
                                                                <td><?php echo $result['conttype'];?></td>
                                                            ...
                                                            <div class="dropdown-secondary dropdown d-inline-block">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="dropdown3" data-dropdown-in="fadeIn" data-dropdown-out="fadeOut">
                                                                    ...
                                                                    <a onclick="return confirm('Are your sure to Delete!')" class="dropdown-item waves-light waves-effect" href="?delcont=<?php echo $result['id'];?>"><i class="icofont icofont-close m-r-10"></i>Remove</a>
                                                                </div>
